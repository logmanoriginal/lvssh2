...
| [`libssh2_channel_read_stderr`](https://libssh2.org/libssh2_channel_read_stderr.html)                                                  | `libssh2.lvlib:libssh2_channel_read_stderr.vi`        |
...
| [`libssh2_channel_setenv`](https://libssh2.org/libssh2_channel_setenv.html)                                                            | See `libssh2_channel_setenv_ex`                       |
| [`libssh2_channel_setenv_ex`](https://libssh2.org/libssh2_channel_setenv_ex.html)                                                      | `libssh2.lvlib:libssh2_channel_setenv_ex.vi`          |
...
| [`libssh2_channel_write_stderr`](https://libssh2.org/libssh2_channel_write_stderr.html)                                                | `libssh2.lvlib:libssh2_channel_write_stderr.vi`       |
...
| [`libssh2_session_get_timeout`](https://libssh2.org/libssh2_session_get_timeout.html)                                                  | `libssh2.lvlib:libssh2_session_get_timeout.vi`        |
...
| [`libssh2_sftp_get_channel`](https://libssh2.org/libssh2_sftp_get_channel.html)                                                        | `libssh2.lvlib:libssh2_sftp_get_channel.vi`           |
...
| [`libssh2_sftp_seek`](https://libssh2.org/libssh2_sftp_seek.html)                                                                      | Deprecated. Use `libssh2_sftp_seek64` instead!        |
